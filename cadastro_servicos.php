<?php
include 'conexao.php';
include 'php/cadastro_servicos.php';
?>
            ...
            <form action="salvar_servico.php" method="POST">
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="numero_proposta" name="numero_proposta" value="<?php echo $numero_proposta; ?>">
                    </div>
                    <div class="form-group">
                ...
                <div class="checkbox-group">
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        echo "<input class='form-check-input' type='checkbox' name='tipo_servico[]' 
                            id='servico_" . $row['id'] . "' value='" . $row['id'] . "'>";
